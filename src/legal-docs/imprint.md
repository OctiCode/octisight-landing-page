...
This page identifies the legal entities operating the OctiSight platform, in compliance with applicable disclosure obligations (including the UK Companies Act 2006 disclosure requirements, the EU ePrivacy Directive, and equivalent Moroccan provisions).

---

## OctiSight LTD (United Kingdom)
...
The persons responsible for the editorial content of `octisight.com` and `app.octisight.io` are the management of OctiSight LTD and OctiSight SARL respectively.

For content-related matters, contact `legal@octisight.com`.
...
The European Commission provides an Online Dispute Resolution (ODR) platform at `ec.europa.eu/consumers/odr`. OctiSight is a B2B service and does not generally contract with consumers; we do not participate in ODR proceedings and are not obliged to do so.

---

## Liability for links

This site may contain links to external third-party websites. We have no influence on the content of those sites and do not accept responsibility for them. The relevant providers are responsible for the content of their own pages.
